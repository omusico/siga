...
public class Extensions implements java.io.Serializable {
     ...
     * @param vExtension
     */
    public void addExtension(com.iver.andami.plugins.config.generate.Extension vExtension)
     ...
     * @param vExtension
     */
    public void addExtension(int index, com.iver.andami.plugins.config.generate.Extension vExtension)
        throws java.lang.IndexOutOfBoundsException
    {
     ...
     */
    public void addSkinExtension(com.iver.andami.plugins.config.generate.SkinExtension vSkinExtension)
        throws java.lang.IndexOutOfBoundsException
    {
     ...
     * @param vSkinExtension
     */
    public void addSkinExtension(int index, com.iver.andami.plugins.config.generate.SkinExtension vSkinExtension)
        throws java.lang.IndexOutOfBoundsException
    {
     ...
     * @param index
     */
    public com.iver.andami.plugins.config.generate.Extension getExtension(int index)
        throws java.lang.IndexOutOfBoundsException
    {
        ...
        return (com.iver.andami.plugins.config.generate.Extension) _extensionList.elementAt(index);
    ...
    public com.iver.andami.plugins.config.generate.Extension[] getExtension()
    {
        ...
        for (int index = 0; index < size; index++) {
            mArray[index] = (com.iver.andami.plugins.config.generate.Extension) _extensionList.elementAt(index);
        }
        return mArray;
     ...
     * @param index
     */
    public com.iver.andami.plugins.config.generate.SkinExtension getSkinExtension(int index)
        throws java.lang.IndexOutOfBoundsException
    {
        //-- check bounds for index
        ...
        return (com.iver.andami.plugins.config.generate.SkinExtension) _skinExtensionList.elementAt(index);
    ...
    public com.iver.andami.plugins.config.generate.SkinExtension[] getSkinExtension()
    {
        ...
        for (int index = 0; index < size; index++) {
            mArray[index] = (com.iver.andami.plugins.config.generate.SkinExtension) _skinExtensionList.elementAt(index);
        }
        return mArray;
     ...
     * @param index
     */
    public com.iver.andami.plugins.config.generate.Extension removeExtension(int index)
    {
     ...
     * @param index
     */
    public com.iver.andami.plugins.config.generate.SkinExtension removeSkinExtension(int index)
    {
     ...
     * @param vExtension
     */
    public void setExtension(int index, com.iver.andami.plugins.config.generate.Extension vExtension)
        throws java.lang.IndexOutOfBoundsException
    {
        //-- check bounds for index
        if ((index < 0) || (index > _extensionList.size())) {
     ...
     */
    public void setExtension(com.iver.andami.plugins.config.generate.Extension[] extensionArray)
    {
        //-- copy array
        _extensionList.removeAllElements();
     ...
     * @param vSkinExtension
     */
    public void setSkinExtension(int index, com.iver.andami.plugins.config.generate.SkinExtension vSkinExtension)
        throws java.lang.IndexOutOfBoundsException
    {
        //-- check bounds for index
        if ((index < 0) || (index > _skinExtensionList.size())) {
     ...
     */
    public void setSkinExtension(com.iver.andami.plugins.config.generate.SkinExtension[] skinExtensionArray)
    {
        //-- copy array
        _skinExtensionList.removeAllElements();
    ...
    public static java.lang.Object unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (com.iver.andami.plugins.config.generate.Extensions) Unmarshaller.unmarshal(com.iver.andami.plugins.config.generate.Extensions.class, reader);
