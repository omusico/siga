...
public class LabelSet implements java.io.Serializable {
     ...
     * @param vLabel
     */
    public void addLabel(int index, com.iver.andami.plugins.config.generate.Label vLabel)
        throws java.lang.IndexOutOfBoundsException
    {
        ...
        throws java.lang.IndexOutOfBoundsException
    {
        ...
        return (com.iver.andami.plugins.config.generate.Label) _labelList.elementAt(index);
    ...
    public com.iver.andami.plugins.config.generate.Label[] getLabel()
    {
        ...
        for (int index = 0; index < size; index++) {
            mArray[index] = (com.iver.andami.plugins.config.generate.Label) _labelList.elementAt(index);
        }
        return mArray;
     ...
     * @param vLabel
     */
    public void setLabel(int index, com.iver.andami.plugins.config.generate.Label vLabel)
        throws java.lang.IndexOutOfBoundsException
    {
        //-- check bounds for index
        if ((index < 0) || (index > _labelList.size())) {
     ...
     * @param labelArray
     */
    public void setLabel(com.iver.andami.plugins.config.generate.Label[] labelArray)
    {
        //-- copy array
        _labelList.removeAllElements();
    ...
    public static java.lang.Object unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (com.iver.andami.plugins.config.generate.LabelSet) Unmarshaller.unmarshal(com.iver.andami.plugins.config.generate.LabelSet.class, reader);
