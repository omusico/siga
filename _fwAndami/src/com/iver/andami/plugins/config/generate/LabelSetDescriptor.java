...
public class LabelSetDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public LabelSetDescriptor() {
        ...
        //-- _labelList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.iver.andami.plugins.config.generate.Label.class, "_labelList", "label", org.exolab.castor.xml.NodeType.Element);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    LabelSet target = (LabelSet) object;
                    target.addLabel( (com.iver.andami.plugins.config.generate.Label) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new com.iver.andami.plugins.config.generate.Label();
            }
        } );
        desc.setHandler(handler);
        desc.setRequired(true);
    ...
    {
        return com.iver.andami.plugins.config.generate.LabelSet.class;
