...
public class PluginConfig implements java.io.Serializable {
     ...
     * @param vDepends
     */
    public void addDepends(com.iver.andami.plugins.config.generate.Depends vDepends)
     ...
     * @param vDepends
     */
    public void addDepends(int index, com.iver.andami.plugins.config.generate.Depends vDepends)
        throws java.lang.IndexOutOfBoundsException
    {
     ...
     * @param vLabelSet
     */
    public void addLabelSet(com.iver.andami.plugins.config.generate.LabelSet vLabelSet)
        throws java.lang.IndexOutOfBoundsException
    {
     ...
     * @param vLabelSet
     */
    public void addLabelSet(int index, com.iver.andami.plugins.config.generate.LabelSet vLabelSet)
        throws java.lang.IndexOutOfBoundsException
    {
        ...
        throws java.lang.IndexOutOfBoundsException
    {
        ...
        return (com.iver.andami.plugins.config.generate.Depends) _dependsList.elementAt(index);
    ...
    public com.iver.andami.plugins.config.generate.Depends[] getDepends()
    {
        ...
        for (int index = 0; index < size; index++) {
            mArray[index] = (com.iver.andami.plugins.config.generate.Depends) _dependsList.elementAt(index);
        }
        return mArray;
     ...
     * @param index
     */
    public com.iver.andami.plugins.config.generate.LabelSet getLabelSet(int index)
        throws java.lang.IndexOutOfBoundsException
    {
        //-- check bounds for index
        ...
        return (com.iver.andami.plugins.config.generate.LabelSet) _labelSetList.elementAt(index);
    ...
    public com.iver.andami.plugins.config.generate.LabelSet[] getLabelSet()
    {
        ...
        for (int index = 0; index < size; index++) {
            mArray[index] = (com.iver.andami.plugins.config.generate.LabelSet) _labelSetList.elementAt(index);
        }
        return mArray;
     ...
     * @param index
     */
    public com.iver.andami.plugins.config.generate.Depends removeDepends(int index)
    {
     ...
     * @param index
     */
    public com.iver.andami.plugins.config.generate.LabelSet removeLabelSet(int index)
    {
     ...
     * @param vDepends
     */
    public void setDepends(int index, com.iver.andami.plugins.config.generate.Depends vDepends)
        throws java.lang.IndexOutOfBoundsException
    {
        //-- check bounds for index
        if ((index < 0) || (index > _dependsList.size())) {
     ...
     * @param dependsArray
     */
    public void setDepends(com.iver.andami.plugins.config.generate.Depends[] dependsArray)
    {
        //-- copy array
        _dependsList.removeAllElements();
     ...
     */
    public void setExtensions(com.iver.andami.plugins.config.generate.Extensions extensions)
    {
     ...
     * @param vLabelSet
     */
    public void setLabelSet(int index, com.iver.andami.plugins.config.generate.LabelSet vLabelSet)
        throws java.lang.IndexOutOfBoundsException
    {
        //-- check bounds for index
        if ((index < 0) || (index > _labelSetList.size())) {
     ...
     * @param labelSetArray
     */
    public void setLabelSet(com.iver.andami.plugins.config.generate.LabelSet[] labelSetArray)
    {
        //-- copy array
        _labelSetList.removeAllElements();
     ...
     */
    public void setLibraries(com.iver.andami.plugins.config.generate.Libraries libraries)
    {
     ...
     */
    public void setPopupMenus(com.iver.andami.plugins.config.generate.PopupMenus popupMenus)
    {
     ...
     */
    public void setResourceBundle(com.iver.andami.plugins.config.generate.ResourceBundle resourceBundle)
    {
    ...
    public static java.lang.Object unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (com.iver.andami.plugins.config.generate.PluginConfig) Unmarshaller.unmarshal(com.iver.andami.plugins.config.generate.PluginConfig.class, reader);
