...
public class PopupMenus implements java.io.Serializable {
     ...
     * @param vPopupMenu
     */
    public void addPopupMenu(com.iver.andami.plugins.config.generate.PopupMenu vPopupMenu)
     ...
     * @param vPopupMenu
     */
    public void addPopupMenu(int index, com.iver.andami.plugins.config.generate.PopupMenu vPopupMenu)
        throws java.lang.IndexOutOfBoundsException
    {
     ...
     * @param index
     */
    public com.iver.andami.plugins.config.generate.PopupMenu getPopupMenu(int index)
        throws java.lang.IndexOutOfBoundsException
    {
        ...
        return (com.iver.andami.plugins.config.generate.PopupMenu) _popupMenuList.elementAt(index);
    ...
    public com.iver.andami.plugins.config.generate.PopupMenu[] getPopupMenu()
    {
        ...
        for (int index = 0; index < size; index++) {
            mArray[index] = (com.iver.andami.plugins.config.generate.PopupMenu) _popupMenuList.elementAt(index);
        }
        return mArray;
     ...
     * @param index
     */
    public com.iver.andami.plugins.config.generate.PopupMenu removePopupMenu(int index)
    {
     ...
     * @param vPopupMenu
     */
    public void setPopupMenu(int index, com.iver.andami.plugins.config.generate.PopupMenu vPopupMenu)
        throws java.lang.IndexOutOfBoundsException
    {
        //-- check bounds for index
        if ((index < 0) || (index > _popupMenuList.size())) {
     ...
     */
    public void setPopupMenu(com.iver.andami.plugins.config.generate.PopupMenu[] popupMenuArray)
    {
        //-- copy array
        _popupMenuList.removeAllElements();
    ...
    public static java.lang.Object unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (com.iver.andami.plugins.config.generate.PopupMenus) Unmarshaller.unmarshal(com.iver.andami.plugins.config.generate.PopupMenus.class, reader);
