...
public class UserMediaSizeName extends MediaSizeName {
    ...
    private UserMediaSizeName(int x) {
	super(x);
    ...
    public UserMediaSizeName(String name) {
    ...
    public UserMediaSizeName(String name, String choice,
