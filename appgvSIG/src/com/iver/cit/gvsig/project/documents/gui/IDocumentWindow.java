 ...
 * clases se usarán para cargar y guardar las propiedades graficas de la ventana
...
public interface IDocumentWindow {
	 ...
	 * estados de sliders, divisores etc. Este método será llamado
	 * para guardar los datos a disco. Lo llamará la clase project para 
	...
	/**
	 * Método para cargar los datos de la ventana de proyecto. El widowData guardado
