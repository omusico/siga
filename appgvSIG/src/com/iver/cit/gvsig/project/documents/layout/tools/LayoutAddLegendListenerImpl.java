...
public class LayoutAddLegendListenerImpl extends LayoutAddRectangleListener {
	...
	public void rectangle(RectangleEvent event) throws BehaviorException {
		FFrameLegend fframe =(FFrameLegend)FrameFactory.createFrameFromName(FFrameLegendFactory.registerName);
		...
		FFrameLegendDialog fframedialog = new FFrameLegendDialog(layout, fframe);
