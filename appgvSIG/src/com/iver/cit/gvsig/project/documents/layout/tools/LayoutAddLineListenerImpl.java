 ...
 */
public class LayoutAddLineListenerImpl implements LayoutPointListener, ILayoutGraphicListener{
	...
	/**
	 * Crea un nuevo LayoutAddLineListenerImpl.
	 *
	 * @param l Layout.
	 */
	public LayoutAddLineListenerImpl(Layout l) {
		this.layout = l;
	}
	...
	public void endGraphic() {
		...
		fframe.update(FFrameGraphics.LINE, layout.getLayoutControl().getAT());
