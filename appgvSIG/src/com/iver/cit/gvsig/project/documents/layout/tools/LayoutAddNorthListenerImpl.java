...
public class LayoutAddNorthListenerImpl extends LayoutAddRectangleListener {
	 ...
	 * @param l Layout.
	 */
	public LayoutAddNorthListenerImpl(Layout l) {
		super(l);
	}
	...
	public void rectangle(RectangleEvent event) throws BehaviorException {
		FFrameNorth fframe =(FFrameNorth)FrameFactory.createFrameFromName(FFrameNorthFactory.registerName);
		...
		FFrameNorthDialog fframedialog = new FFrameNorthDialog(layout, fframe);
