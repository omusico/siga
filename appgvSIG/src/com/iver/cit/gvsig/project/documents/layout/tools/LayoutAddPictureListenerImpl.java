 ...
 */
public class LayoutAddPictureListenerImpl extends LayoutAddRectangleListener {
	 ...
	 * @param l Layout.
	 */
	public LayoutAddPictureListenerImpl(Layout l) {
		super(l);
	}
	...
	public void rectangle(RectangleEvent event) throws BehaviorException {
		FFramePicture fframe =(FFramePicture)FrameFactory.createFrameFromName(FFramePictureFactory.registerName);
		...
		FFramePictureDialog fframedialog = new FFramePictureDialog(layout, fframe);
