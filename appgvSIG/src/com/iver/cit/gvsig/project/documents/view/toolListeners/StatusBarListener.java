 ...
 *    <code><b><i>S?Gº M' S''</i></b></code>, having:<br>
 *    <ul>
...
public class StatusBarListener implements PointListener {
	...
	/*
	 * 050211, jmorell: Método modificado para mejorar la manera de mostrar las
	 * coordenadas geodésicas en la barra de estado. Muestra Lat y Lon y aumenta
	 * el número de decimales para cuando trabajemos en coordenadas geodésicas.
	 *
	 * (non-Javadoc)
	...
	public void point(PointEvent event) throws BehaviorException {
		...
		if (mF != null){
            ...
            // FJP: No se debe llamar a setControlValue desde aquí, porque
            // cambia la escala, y con ella el viewPort (además, de
            // la vista que no es).
