 ...
 *
 */
public interface ActiveLayerChangeEventListener extends EventListener {

    /**
     * Notification method
     * 
     * @param alce describes event
     */
    public void activeLayerChanged(ActiveLayerChangeEvent alce);
