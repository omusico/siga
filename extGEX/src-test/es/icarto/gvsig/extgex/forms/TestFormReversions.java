...
public class TestFormReversions extends CommonMethodsForTestDBForms {
	...
	return FormReversions.TABLENAME;
    }
	...
	try {
	    ...
	    AbstractForm dialog = new FormReversions((FLyrVect) layer, null);
