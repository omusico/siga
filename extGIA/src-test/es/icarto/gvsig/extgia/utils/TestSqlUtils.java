...
public class TestSqlUtils {
    ...
    // mockData.put("fecha_certificado",
    // ValueFactory.createValue("01/01/1980"));
    //
    // SqlUtils.insert("audasa_extgia", "areas_descanso_trabajos", mockData);
    //
    // Statement st =
    // DBSession.getCurrentSession().getJavaConnection().createStatement();
    // ResultSet rs =
    // st.executeQuery("SELECT * FROM audasa_extgia.areas_descanso_trabajos WHERE "
    // +
    ...
    // mockData.put("observaciones", ValueFactory.createValue("bar"));
    //
    // SqlUtils.insert("audasa_extgia", "areas_descanso_reconocimientos",
    // mockData);
    //
    // Statement st =
    // DBSession.getCurrentSession().getJavaConnection().createStatement();
    // ResultSet rs =
    // st.executeQuery("SELECT * FROM audasa_extgia.areas_descanso_reconocimientos"
    // +
    // " WHERE " +
    // "id_area_descanso = '2311360581' AND nombre_revisor = 'foo'");
    // boolean inserted = false;
    // if (rs.next()) {
    // inserted = true;
    // }
    ...
    // DBSession.getCurrentSession().getJavaConnection().createStatement();
    // ResultSet rs =
    // st.executeQuery("SELECT * FROM audasa_extgia.areas_descanso_ramales" +
    ...
    //
    // SqlUtils.insert("audasa_extgia", "enlaces_carreteras_enlazadas",
    // mockData);
    //
    // Statement st =
    // DBSession.getCurrentSession().getJavaConnection().createStatement();
    // ResultSet rs =
    // st.executeQuery("SELECT * FROM audasa_extgia.enlaces_carreteras_enlazadas"
    // +
    ...
    //
    // @Test
    // public void testInsertCarreteraEnlazadaWithNullValues() throws
    // SQLException {
    // HashMap<String, Value> mockData = new HashMap<String, Value>();
    // mockData.put("id_enlace", ValueFactory.createValue("111415031007810"));
    // mockData.put("id_carretera_enlazada", ValueFactory.createNullValue());
    ...
    // mockData.put("fecha_certificado",
    // ValueFactory.createValue("31/12/1980"));
    //
    ...
    // mockData.get("medicion_contratista").toString());
    // assertEquals(rs.getString(6),
    // mockData.get("medicion_audasa").toString());
    ...
    // +
    // " WHERE " +
    // "id_area_descanso = '2311360581' AND nombre_revisor = 'bar'");
    // boolean inserted = false;
    // if (rs.next()) {
    // inserted = true;
    ...
    // assertEquals(rs.getString(5),
    // mockData.get("sup_pavimentada").toString());
    ...
    // mockData.get("zona_ajardinada").toString());
    ...
    //
    // @Test
    // public void testUpdateReconocimientoDeletingSomeValue() throws
    // SQLException {
    // HashMap<String, Value> mockData = new HashMap<String, Value>();
    // mockData.put("nombre_revisor", ValueFactory.createValue("bar"));
    // mockData.put("fecha_inspeccion", ValueFactory.createNullValue());
    ...
    // mockData.get("clave_carretera").toString());
    ...
    //
    // @Test
    // public void testUpdateCarreteraEnlazadaDeletingSomeValue() throws
    // SQLException {
    // HashMap<String, Value> mockData = new HashMap<String, Value>();
    // mockData.put("clave_carretera", ValueFactory.createValue("bar"));
    // mockData.put("pk", ValueFactory.createNullValue());
    ...
    // rs.next();
    //
    // SqlUtils.delete("audasa_extgia", "areas_descanso_trabajos", "id_trabajo",
    // rs.getString(2));
    //
    ...
    // st = DBSession.getCurrentSession().getJavaConnection().createStatement();
    // rs =
    // st.executeQuery("SELECT * FROM audasa_extgia.areas_descanso_reconocimientos WHERE "
    // +
    ...
    // st = DBSession.getCurrentSession().getJavaConnection().createStatement();
    // rs =
    // st.executeQuery("SELECT * FROM audasa_extgia.areas_descanso_ramales WHERE "
    // +
    ...
    // st = DBSession.getCurrentSession().getJavaConnection().createStatement();
    // rs =
    // st.executeQuery("SELECT * FROM audasa_extgia.enlaces_carreteras_enlazadas WHERE "
    // +
    // "id_enlace = '111415031007810' AND id_carretera_enlazada = '" +
    // rs.getString(2) + "'");
    // boolean inserted = false;
    // if (rs.next()) {
    // inserted = true;
    ...
    // mockData.put("material_retrorreflectante",
    // ValueFactory.createValue("bar4"));
    ...
    // mockData.put("fecha_fabricacion",
    // ValueFactory.createValue("01/01/1980"));
    // mockData.put("fecha_instalacion",
    // ValueFactory.createValue("01/01/1980"));
    ...
    //
    // SqlUtils.insert("audasa_extgia", "senhalizacion_vertical_senhales",
    // mockData);
    //
    // Statement st =
    // DBSession.getCurrentSession().getJavaConnection().createStatement();
    // ResultSet rs =
    // st.executeQuery("SELECT * FROM audasa_extgia.senhalizacion_vertical_senhales"
    // +
    ...
    // assertEquals(rs.getString(6),
    // String.valueOf(mockData.get("panel_complementario").toString().charAt(0)));
    ...
    // String.valueOf(mockData.get("reversible").toString().charAt(0)));
    // assertEquals(rs.getString(10),
    // String.valueOf(mockData.get("luminosa").toString().charAt(0)));
    // assertEquals(rs.getString(11),
    // mockData.get("tipo_superficie").toString());
    // assertEquals(rs.getString(12),
    // mockData.get("material_superficie").toString());
    // assertEquals(rs.getString(13),
    // mockData.get("material_retrorreflectante").toString());
    // assertEquals(rs.getString(14),
    // mockData.get("nivel_reflectancia").toString());
    ...
    // assertEquals(rs.getString(23),
    // String.valueOf(mockData.get("marcado_ce").toString().charAt(0)));
    ...
    // st = DBSession.getCurrentSession().getJavaConnection().createStatement();
    // rs =
    // st.executeQuery("SELECT * FROM audasa_extgia.senhalizacion_vertical_senhales WHERE "
    // +
    // "id_elemento_senhalizacion = '1' AND id_senhal_vertical = '" +
    // rs.getString(2) + "'");
    // boolean inserted = false;
    // if (rs.next()) {
    // inserted = true;
    ...
    // DBSession.getCurrentSession().getJavaConnection().createStatement();
    // ResultSet rs =
    // st.executeQuery("SELECT * FROM audasa_extgia.firme_trabajos" +
    ...
    // assertEquals(rs.getString(10),
    // mockData.get("zahorra_artificial_cm").toString());
    // assertEquals(rs.getString(11),
    // mockData.get("suelo_cemento_cm").toString());
    // assertEquals(rs.getString(12),
    // mockData.get("grava_cemento_cm").toString());
    // assertEquals(rs.getString(13), mockData.get("mbc_base_cm").toString());
    // assertEquals(rs.getString(14),
    // mockData.get("mbc_intermedia_cm").toString());
    // assertEquals(rs.getString(15),
    // mockData.get("mbc_rodadura_cm").toString());
    // assertEquals(rs.getString(16), mockData.get("explanada").toString());
    // assertEquals(rs.getString(17),
    // mockData.get("zahorra_artificial").toString());
    // assertEquals(rs.getString(18), mockData.get("suelo_cemento").toString());
    // assertEquals(rs.getString(19),
    // mockData.get("gc_arido_grueso").toString());
    ...
    // assertEquals(rs.getString(23),
    // mockData.get("mbc_bas_arido_grueso").toString());
    // assertEquals(rs.getString(24),
    // mockData.get("mbc_bas_arido_fino").toString());
    // assertEquals(rs.getString(25),
    // mockData.get("mbc_bas_filler").toString());
    // assertEquals(rs.getString(26),
    // mockData.get("mbc_bas_ligante").toString());
    // assertEquals(rs.getString(27), mockData.get("mbc_rod_huso").toString());
    // assertEquals(rs.getString(28),
    // mockData.get("mbc_rod_arido_grueso").toString());
    // assertEquals(rs.getString(29),
    // mockData.get("mbc_rod_arido_fino").toString());
    // assertEquals(rs.getString(30),
    // mockData.get("mbc_rod_filler").toString());
    // assertEquals(rs.getString(31),
    // mockData.get("mbc_rod_ligante").toString());
    // }
    // assertEquals(true, inserted);
    // }
    //
