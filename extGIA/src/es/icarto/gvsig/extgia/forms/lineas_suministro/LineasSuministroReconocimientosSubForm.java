...
public class LineasSuministroReconocimientosSubForm extends BasicAbstractSubForm {

    public LineasSuministroReconocimientosSubForm(String formFile,
	...
	return this
		...
		.getClassLoader()
		.getResource(
			"rules/lineas_suministro_reconocimientos_metadata.xml")
			.getPath();
    }
