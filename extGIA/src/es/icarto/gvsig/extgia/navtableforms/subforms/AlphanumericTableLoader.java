package es.icarto.gvsig.extgia.navtableforms.subforms;
...
public class AlphanumericTableLoader {
	...
	tableNames[0] = "taludes_reconocimiento_estado";
	tableNames[1] = "taludes_trabajos";
	...
	LayerFactory.getDataSourceFactory().addDBDataSourceByTable(tableName,
		...
		"audasa_extgia" + "." + tableName, "PostgreSQL Alphanumeric");
