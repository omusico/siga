...
public class SpatialJoinGeoprocessPlugin extends GeoprocessPluginAbstract  implements IGeoprocessPlugin {
	...
	static{
		...
		geoprocessName = PluginServices.getText(null, "Enlace_espacial");
	}
	...
	public URL getImgDescription() {
		return PluginServices.getIconTheme().getURL("spatialjoindesc-resource");
	}
