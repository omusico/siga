...
* $Id$
* $Log$
* Revision 1.7  2007-09-19 16:08:28  jaume
...
public class UnionGeoprocessPlugin extends GeoprocessPluginAbstract  implements IGeoprocessPlugin {
	...
	static{
		...
		geoprocessName = PluginServices.getText(null, "Union");
	}
	...
	public URL getImgDescription() {
		return PluginServices.getIconTheme().getURL("uniondesc-resource");
	}
