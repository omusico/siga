...
public class TGeotransformProcessRMS extends TestCase {
	...
	public void testStack() {
		...
		assertEquals(Math.pow(x_1 - gpl.get(0).pixelPoint.getX(), 2), list.get(0).getErrorX(), 0.001);
		assertEquals(Math.pow(x_2 - gpl.get(1).pixelPoint.getX(), 2), list.get(1).getErrorX(), 0.001);
		assertEquals(Math.pow(x_3 - gpl.get(2).pixelPoint.getX(), 2), list.get(2).getErrorX(), 0.001);

		// Comparativa del error en y
		assertEquals(Math.pow(y_1 - gpl.get(0).pixelPoint.getY(), 2), list.get(0).getErrorY(), 0.001);
		assertEquals(Math.pow(y_2 - gpl.get(1).pixelPoint.getY(), 2), list.get(1).getErrorY(), 0.001);
		assertEquals(Math.pow(y_3 - gpl.get(2).pixelPoint.getY(), 2), list.get(2).getErrorY(), 0.001);	
				
		double rms1=Math.sqrt( Math.pow(x_1 - gpl.get(0).pixelPoint.getX(), 2)+ Math.pow(y_1 - gpl.get(0).pixelPoint.getY(), 2));
		double rms2=Math.sqrt( Math.pow(x_2 - gpl.get(1).pixelPoint.getX(), 2)+ Math.pow(y_2 - gpl.get(1).pixelPoint.getY(), 2));
		double rms3=Math.sqrt( Math.pow(x_3 - gpl.get(2).pixelPoint.getX(), 2)+ Math.pow(y_3 - gpl.get(2).pixelPoint.getY(), 2));
