...
public class RasterDrawStrategy {
	 ...
	 */
	public RasterDrawStrategy(MapContext mapContext, FLyrRasterSE lyrRaster) throws ExpansionFileReadException, ReadDriverException {
	 ...
	 * @throws ExpansionFileReadException 
	 */
	public void stackStrategy() throws ExpansionFileReadException, ReadDriverException {
		...
		for (int i = (listLayers.size() - 1); i >= 0; i--) {
			...
			if(rLyr.getRenderFilterList() == null || rLyr.getFullExtent() == null)
				continue;
