...
public class GeoRasterBehavior extends Behavior {
	...
	public GeoRasterBehavior(PanListener zili, ITransformIO windowIO) {
		cur = zili.getCursor();
		behavior[0] = new TranslateBehavior(this, cur, windowIO);
		behavior[1] = new ScaleBehavior(this, cur, windowIO);
		behavior[2] = new RotationBehavior(this, cur, windowIO);
		behavior[3] = new ShearBehavior(this, cur, windowIO);
	}
