...
public class MethodSelectorPanel extends JPanel {
	...
	public JRadioButton getRbScale() {
		if (rbScale == null) {
			...
			rbScale.setText(PluginServices.getText(null, "scale"));
	...
	public JRadioButton getRbMtsPixel() {
		if (rbMtsPixel == null) {
			...
			rbMtsPixel.setText(PluginServices.getText(null, "mts_pixel"));
		}
		return rbMtsPixel;
	}
	...
	public JRadioButton getRbSize() {
		if (rbSize == null) {
			...
			rbSize.setText(PluginServices.getText(null, "size"));
		}
		return rbSize;
	}
