...
public class PotracePanel extends BasePanel {
	...
	public JComboBox getPolicy() {
		if (policy == null) {
			...
			policy.addItem(RasterToolsUtil.getText(this, "black"));
			policy.addItem(RasterToolsUtil.getText(this, "white"));
			policy.addItem(RasterToolsUtil.getText(this, "right"));
			policy.addItem(RasterToolsUtil.getText(this, "left"));
			policy.addItem(RasterToolsUtil.getText(this, "minority"));
			policy.addItem(RasterToolsUtil.getText(this, "majority"));
			policy.addItem(RasterToolsUtil.getText(this, "random"));
			policy.setSelectedItem(RasterToolsUtil.getText(this, "minority"));
		}
		return policy;
	}
