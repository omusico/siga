...
public class GradientFillSymbolTest extends AbstractSymbolTestCase {
	public GradientFillSymbolTest() {
		super(GradientFillSymbol.class);
	}
	
	@Override
	public ISymbol newInstance() {
		GradientFillSymbol gfs = (GradientFillSymbol) super.newInstance();
		return gfs;
	}
}