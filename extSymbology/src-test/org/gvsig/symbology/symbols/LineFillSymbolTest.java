...
public class LineFillSymbolTest extends AbstractSymbolTestCase {
	public LineFillSymbolTest() {
		super(LineFillSymbol.class);
	}
	
	@Override
	public ISymbol newInstance() {
		LineFillSymbol lfs = (LineFillSymbol) super.newInstance();
		return lfs;
	}
}