...
public class MarkerFillSymbolTest extends AbstractSymbolTestCase {
	public MarkerFillSymbolTest() {
		super(MarkerFillSymbol.class);
	}
	
	@Override
	public ISymbol newInstance() {
		MarkerFillSymbol mfs = (MarkerFillSymbol) super.newInstance();
		return mfs;
	}
}