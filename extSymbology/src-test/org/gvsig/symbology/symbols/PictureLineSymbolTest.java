...
public class PictureLineSymbolTest extends AbstractSymbolTestCase {
	...
	public ISymbol newInstance() {
		...
		try {
			pls.setImage(new File(PictureLineSymbolTest.class.getResource("picture-line.png").getFile()).toURL());
			pls.setSelImage(new File(PictureLineSymbolTest.class.getResource("picture-line-selected.png").getFile()).toURL());
			return pls;
		} catch (IOException e) {
			e.printStackTrace();
