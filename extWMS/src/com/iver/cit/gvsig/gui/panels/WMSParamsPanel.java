 ...
 * refrescan los valores de componentes cuyos valores dependen de aquï¿½llos
 * seleccionados en otros componentes para evitar que se escoja una combinaciï¿½n
 * de opciones errï¿½nea asï¿½ como una funciï¿½n (isCorrectlyConfigured()) que
 * comprueba si la combinaciï¿½n escogida actualmente es suficiente para lanzar
 * una operaciï¿½n GetMap correctamente.
 *
 * La informaciï¿½n obtiene a partir de un objeto WMSWizardDataSource.
 *
...
public class WMSParamsPanel extends WizardPanel {
	...
	// TODO: crear nuevo constructor para aï¿½adir los panels que quieras...
					...
					.addTreeSelectionListener(new javax.swing.event.TreeSelectionListener() {
						public void valueChanged(
							...
							TreePath[] selecciones = getTreeLayers()
									.getSelectionPaths();
							if (selecciones != null) // no entenc perquï¿½
														// peta acï¿½ i li
														// arriba null a
														// voltes...
							{
							...
							// Podemos añadir una rama entera
	...
	public void addLayer() {
		...
		for (int i = 0; i < selecciones.length; i++) {
			...
			if (nodo.getChildren().size() > 0) {
				...
				// continue;
				// Nuevo: Iteramos por todos los subnodos para añadir todos ellos.
			...
			// TODO: AQUÍ QUIZÁS DEBERÍAMOS COMPROBAR SI YA ESTÁ EN LA LISTA PARA EVITAR DUPLICADOS.
			// Lo dejamos así por si el usuario quiere montarse el servicio a su gusto.
...
//						+ " " + getSRS() + " -> " + latLonID);
	 ...
	 *
	 * Devuelve el ï¿½ndice de la pï¿½gina actual del wizard.
	 *
	 * @return
	 */
	 ...
	 *
	 * Devuelve el nï¿½mero de solapas que tiene actualmente el WMSParamsPanel
	 *
	 * @return int
	 */
	 ...
	 * </p>
	 * <p>
	 * Devuelve el ï¿½ndice de la anterior pï¿½gina habilitada del wizard o -1
	 * si no hay ninguna.
	 * </p>
	 *
	 ...
	 * </p>
	 * <p>
	 * Devuelve el ï¿½ndice de la siguiente pï¿½gina habilitada del wizard o -1
	 * si no hay ninguna.
	 * </p>
	 *
	 * @return The index, or -1 if there is no one.
