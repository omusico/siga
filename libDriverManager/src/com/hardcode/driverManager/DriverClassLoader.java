...
public class DriverClassLoader extends URLClassLoader {
     ...
     *
     * @param jars Array con la ruta de los jars en los que buscará las clases
     *        el plugin
     * @param baseDir Directorio base del plugin que se carga. Es en directorio
     *        donde se buscan los resources en el método getResources
     * @param cl ClassLoader padre del classLoader, al que se le pedirá
     ...
     * Si no se encuentra el recurso ahí se invoca a getResource del
     * classloader padre, que buscará en el jar de la aplicación. Si ahí
     * tampoco se encuentra nada se devolverá null.
     *
