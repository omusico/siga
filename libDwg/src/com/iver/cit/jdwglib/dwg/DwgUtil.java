...
public final class DwgUtil {
	...
	public static ArrayList getTextString(int[] data, int offset) throws RuntimeException {
		...
		String string;
		//FIXME: Habría que ver de tomar el encoding correcto
		// a partir del Codepage que se encuentra en la cabecera
		// del archivo dwg, pero nos falta información
	...
	public static ArrayList getCmColor(int[] intData, int offset, String version) throws RuntimeException {
		...
		//FIXME: para versiones superiores habrÃ¡ que ampliar la condiciÃ³n
