 ...
 * Aï¿½adido o modificado el metodo clone para que el DwgObject se encargue de las propiedades comunes a todos los objetos.
 * Aï¿½adido el metodo fill.
 *
...
public class DwgPFacePolyline extends DwgObject
	...
	// In DWG 12 vertices are after the entity
	 if(firstVertexHandle != null && lastVertexHandle != null){
			...
			// TODO: No se debe mandar nunca una polilï¿½nea sin puntos, si
			// esto
