...
/* CVS MESSAGES:
*
* $Id: DwgVertexPFaceFaceReader15.java,v 1.1.2.1 2007/03/21 19:49:16 azabala Exp $
* $Log: DwgVertexPFaceFaceReader15.java,v $
...
public class DwgVertexPFaceFaceReader2004 extends AbstractDwg2004Reader {
	...
	public void readSpecificObj(int[] data, int offset, DwgObject dwgObj)
		 ...
		 bitPos = readObjectHeader(data, offset, v);
