...
public class SHP {
    ...
    /**
     * Crea un fichero en formato shape con las geometrías que se pasan como
     * parámetro en forma de array, un bitset para saber las seleccionadas, un
     * SelectableDataSource para obtener los valores y el fichero a crear.
     *
     * @param fgs Array de geometrías.
     * @param bitset Bitset con la selección.
    ...
    /**
     * Obtiene un fichero shape con las geometrías que se pasan como parámetro,
     * sin crear un dbf.
     *
