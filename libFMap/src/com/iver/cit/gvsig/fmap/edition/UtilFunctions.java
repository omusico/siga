...
public class UtilFunctions {
	...
	/**
	 * Obtiene el centro del círculo que pasa por los tres puntos que se pasan
	 * como  parámetro
	 *
	 * @param p1 primer punto del círculo cuyo centro se quiere obtener
	 * @param p2 segundo punto del círculo cuyo centro se quiere obtener
	 * @param p3 tercer punto del círculo cuyo centro se quiere obtener
	 *
	 * @return Devuelve null si los puntos están alineados o no son 3 puntos
	 * 		   distintos
	 */
	...
	/**
	 * Obtiene el ángulo del vector que se pasa como parámetro con el vector
	 ...
	 * 		  vuelta a la circunferencia
	 *
	 * @return distancia entre los ángulos
	 */
	 ...
	 * el arco porque los puntos están alineados o los 3 puntos no son
	 * distintos
	 *
	 * @param p1
	 * @param p2
