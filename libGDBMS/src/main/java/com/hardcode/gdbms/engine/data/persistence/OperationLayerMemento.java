...
public class OperationLayerMemento implements Memento {
    ...
    /**
     * @see com.hardcode.gdbms.engine.data.persistence.Memento#setContentHandler(org.xml.sax.ContentHandler)
     */
    ...
    /**
     * @see com.hardcode.gdbms.engine.data.persistence.Memento#getXML()
     */
