...
/**
 * Adapta el nodo que representa una instrucción select en el árbol  sintáctico
 * de entrada
 *
...
public class SelectAdapter extends Adapter {
    ...
    /**
     * Obtiene las expresiones de los campos de la cláusula SELECT o null si
     * hay un ''.
     *
    ...
    /**
     * Devuelve true si la palabra clave DISTINCT se usó y false en caso
     * contrario
     *
     * @return Devuelve true si se utilizó la palabra clave DISTINCT
     */
