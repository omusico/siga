...
public abstract class GPEGmlWriterHandlerImplementor extends GPEXmlWriterHandlerImplementor{
	...
	protected void initPrefixes() throws XmlStreamException{
		...
		writer.setPrefix(GPEDefaults.getStringProperty(XmlProperties.DEFAULT_NAMESPACE_PREFIX),
				GPEDefaults.getStringProperty(XmlProperties.DEFAULT_NAMESPACE_URI));
	}
