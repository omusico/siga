...
public class LookAtBinding{
	 ...
	 * @throws IOException 
	 */
	public void parse(IXmlStreamReader parser,GPEDefaultKmlParser handler) throws XmlStreamException, IOException {
		...
		while (!endFeature){
			...
			case IXmlStreamReader.END_ELEMENT:
				if (CompareUtils.compareWithOutNamespace(tag,Kml2_1_Tags.LOOKAT)){						
					endFeature = true;
				}
				break;
