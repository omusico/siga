...
public class GeometryBinding {
	 ...
	 */
	public String getID(IXmlStreamReader parser,GPEDefaultKmlParser handler) throws XmlStreamException{
		String id = null;
		for (int i=0 ; i<parser.getAttributeCount() ; i++){
			if (CompareUtils.compareWithOutNamespace(parser.getAttributeName(i),Kml2_1_Tags.GEOMETRY_ID)){
