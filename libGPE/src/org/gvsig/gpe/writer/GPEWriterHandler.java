...
//		}		
	...
	/**
	 * Useful to know exactly the writer of the layer, and for example, take care
	 * of the legend of the layer.
	 * @return writer handler
	 */
	public IGPEWriterHandlerImplementor getWriterHandlerImplementor() {
		return writerImplementor;
	}
