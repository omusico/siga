 ...
 * zona, se ocupa de leer automáticamente el trozo que le falta.
 */
public class BigByteBuffer {

    private static long DEFAULT_SIZE = 50*1024*1024; // 50 Megas máximo
    ...
    /**
     * Revisa la posición absoluta, y si hace falta, carga el buffer
