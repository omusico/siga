...
public class IdrAitoff extends MapProjection {

    private final double longitudeOfCenter;

    protected IdrAitoff(ParameterValueGroup parameters) throws ParameterNotFoundException {
		super(parameters);
	...
	public static class Provider extends AbstractProvider {
        ...
        static final ParameterDescriptorGroup PARAMETERS = createDescriptorGroup(new NamedIdentifier[] {
                new NamedIdentifier(CitationImpl.OGC,      "Aitoff"),
    			new NamedIdentifier(CitationImpl.EPSG,     "Aitoff"),
...
//                                    VocabularyKeys.EQUIDISTANT_CYLINDRICAL_PROJECTION))
        ...
        {
            return new IdrAitoff(parameters);
        }
    }
