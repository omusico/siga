...
public class IdrCrasterParabolic extends MapProjection {

    private final double longitudeOfCenter;

    protected IdrCrasterParabolic(ParameterValueGroup parameters) throws ParameterNotFoundException {
		super(parameters);
	...
	public static class Provider extends AbstractProvider {
        ...
        static final ParameterDescriptor LONGITUDE_OF_CENTER = createDescriptor(
                new NamedIdentifier[] {
        ...
        static final ParameterDescriptorGroup PARAMETERS = createDescriptorGroup(new NamedIdentifier[] {
                new NamedIdentifier(CitationImpl.OGC,      "CrasterParabolic"),
    			new NamedIdentifier(CitationImpl.EPSG,     "Craster-Parabolic"),
    			new NamedIdentifier(CitationImpl.EPSG,     "Craster_Parabolic"),
...
//                                    VocabularyKeys.EQUIDISTANT_CYLINDRICAL_PROJECTION))
        ...
        {
            return new IdrCrasterParabolic(parameters);
        }
    }
