...
public class IdrEckertI extends MapProjection {

    private final double longitudeOfCenter;

    protected IdrEckertI(ParameterValueGroup parameters) throws ParameterNotFoundException {
		super(parameters);
    ...
    public static final ParameterDescriptor LONGITUDE_OF_CENTER = createDescriptor(
        ...
        static final ParameterDescriptorGroup PARAMETERS = createDescriptorGroup(new NamedIdentifier[] {
                new NamedIdentifier(CitationImpl.OGC,      "Eckert I"),
    			new NamedIdentifier(CitationImpl.EPSG,     "Eckert-I"),
    			new NamedIdentifier(CitationImpl.EPSG,     "Eckert_I"),
...
//                                    VocabularyKeys.EQUIDISTANT_CYLINDRICAL_PROJECTION))
        ...
        {
            return new IdrEckertI(parameters);
        }
    }
