...
public class IdrEckertIII extends MapProjection {

    private final double longitudeOfCenter;

    protected IdrEckertIII(ParameterValueGroup parameters) throws ParameterNotFoundException {
		super(parameters);
	...
	public static class Provider extends AbstractProvider {
        ...
        static final ParameterDescriptorGroup PARAMETERS = createDescriptorGroup(new NamedIdentifier[] {
                new NamedIdentifier(CitationImpl.OGC,      "Eckert III"),
    			new NamedIdentifier(CitationImpl.EPSG,     "Eckert-III"),
    			new NamedIdentifier(CitationImpl.EPSG,     "Eckert_III"),
...
//                                    VocabularyKeys.EQUIDISTANT_CYLINDRICAL_PROJECTION))
        ...
        {
            return new IdrEckertIII(parameters);
        }
    }
