...
public class IdrEckertVI extends MapProjection {


    protected IdrEckertVI(ParameterValueGroup parameters) throws ParameterNotFoundException {
		super(parameters);
	...
	public static class Provider extends AbstractProvider {
	        ...
	        public static final ParameterDescriptorGroup PARAMETERS = createDescriptorGroup(new NamedIdentifier[] {
	                new NamedIdentifier(CitationImpl.OGC,      "Eckert_VI"),
        			new NamedIdentifier(CitationImpl.EPSG,     "Eckert VI"),
...
//	                                    VocabularyKeys.EQUIDISTANT_CYLINDRICAL_PROJECTION))
	        ...
	        {
	        	return new IdrEckertVI(parameters);
	        }
	    }
