...
public class IdrGoode extends MapProjection {


    protected IdrGoode(ParameterValueGroup parameters) throws ParameterNotFoundException {
		super(parameters);
	...
	public static class Provider extends AbstractProvider {
	        ...
	        static final ParameterDescriptorGroup PARAMETERS = createDescriptorGroup(new NamedIdentifier[] {
	                new NamedIdentifier(CitationImpl.OGC,      "Goode"),
        			new NamedIdentifier(CitationImpl.EPSG,     "Goode"),
