...
public class IdrHammerAitoff extends MapProjection {

    private final double longitudeOfCenter;

    protected IdrHammerAitoff(ParameterValueGroup parameters) throws ParameterNotFoundException {
		super(parameters);
	...
	public static class Provider extends AbstractProvider {
        ...
        static final ParameterDescriptorGroup PARAMETERS = createDescriptorGroup(new NamedIdentifier[] {
                new NamedIdentifier(CitationImpl.OGC,      "Hammer Aitoff"),
    			new NamedIdentifier(CitationImpl.EPSG,     "Hammer_Aitoff"),
    			new NamedIdentifier(CitationImpl.EPSG,     "Hammer-Aitoff"),
    			new NamedIdentifier(CitationImpl.EPSG,     "Hammer"),
...
//                                    VocabularyKeys.EQUIDISTANT_CYLINDRICAL_PROJECTION))
        ...
        {
            return new IdrHammerAitoff(parameters);
        }
    }
