...
public class IdrLambertConformalWestOrientated extends MapProjection {
	...
	public static class Provider extends AbstractProvider {
        ...
        static final ParameterDescriptorGroup PARAMETERS = createDescriptorGroup(new NamedIdentifier[] {
                new NamedIdentifier(CitationImpl.OGC,      "Lambert_Conic_Conformal_(West_Orientated)"),
    			new NamedIdentifier(CitationImpl.EPSG,     "Lambert_Conic_Conformal_(West_Orientated)"),
                new NamedIdentifier(CitationImpl.EPSG,     "Lambert Conic Conformal (West Orientated)"),
