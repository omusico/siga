...
public class IdrMollweide extends MapProjection {


    protected IdrMollweide(ParameterValueGroup parameters) throws ParameterNotFoundException {
		super(parameters);
	...
	public static class Provider extends AbstractProvider {
	        ...
	        static final ParameterDescriptorGroup PARAMETERS = createDescriptorGroup(new NamedIdentifier[] {
	                new NamedIdentifier(CitationImpl.OGC,      "Mollweide"),
        			new NamedIdentifier(CitationImpl.EPSG,     "Hornolographic"),
        			new NamedIdentifier(CitationImpl.EPSG,     "Babinet"),
        			new NamedIdentifier(CitationImpl.EPSG,     "Elliptical"),
...
//	                                    VocabularyKeys.EQUIDISTANT_CYLINDRICAL_PROJECTION))
	        ...
	        {
	        	return new IdrMollweide(parameters);
	        }
	    }
