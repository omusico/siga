...
public class IdrNearSidedPerspective extends MapProjection {
    protected final double latitudeOfCenter;
    protected final double longitudeOfCenter;
    protected final double height;
    protected IdrNearSidedPerspective(final ParameterValueGroup parameters) throws ParameterNotFoundException {
        super(parameters);
        ...
        if (expected.contains(Provider.SCALE_FACTOR)) {
        	height = Math.abs(doubleValue(expected,
                                        Provider.SCALE_FACTOR, parameters));
            ensureLongitudeInRange(Provider.SCALE_FACTOR, height, false);
        } else {
            // standard parallel is the equator (Plate Carree or Equirectangular)
        	height = 0.001;
        }
    ...
    public ParameterValueGroup getParameterValues() {
        ...
        set(expected, Provider.SCALE_FACTOR,      values, height       );
        return values;
    }
    ...
    public static class Provider extends AbstractProvider {
       ...
       public static final ParameterDescriptor SCALE_FACTOR = createDescriptor(
               new NamedIdentifier[] {
                   new NamedIdentifier(CitationImpl.OGC,     "Height"),
                   new NamedIdentifier(CitationImpl.OGC,     "height"),
                   new NamedIdentifier(CitationImpl.EPSG,    "height"),
               }, 0.001, -100000000.0, 100000000.0, SI.METER);


        static final ParameterDescriptorGroup PARAMETERS = createDescriptorGroup(new NamedIdentifier[] {
            new NamedIdentifier(CitationImpl.OGC,     "Near-Sided Perspective"),
            new NamedIdentifier(CitationImpl.OGC,     "Near Sided Perspective"),
            new NamedIdentifier(CitationImpl.OGC,     "Near-Sided-Perspective"),
            new NamedIdentifier(CitationImpl.OGC,     "Near_Sided_Perspective"),
            new NamedIdentifier(CitationImpl.GEOTIFF, "Vertical Near Side Perspective"),
            new NamedIdentifier(CitationImpl.GEOTIFF, "Vertical-Near-Side-Perspective"),
            new NamedIdentifier(CitationImpl.EPSG, "Vertical_Near_Side_Perspective"),
        ...
        {
            return new IdrNearSidedPerspective(parameters);
        }
    }
