...
public class IdrPolyconic extends MapProjection {

    private final double latitudeOfOrigin;

    protected IdrPolyconic(ParameterValueGroup parameters) throws ParameterNotFoundException {
		super(parameters);
	...
	public static class Provider extends AbstractProvider {
        ...
        static final ParameterDescriptorGroup PARAMETERS = createDescriptorGroup(new NamedIdentifier[] {
    			...
    			new NamedIdentifier(CitationImpl.EPSG,     "American Polyconic"),//,
    			new NamedIdentifier(CitationImpl.EPSG,     "American_Polyconic"),
...
//                                    VocabularyKeys.EQUIDISTANT_CYLINDRICAL_PROJECTION))
        ...
        {
            return new IdrPolyconic(parameters);
        }
    }
