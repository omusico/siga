...
public class IdrQuarticAuthalic extends MapProjection {

    private final double longitudeOfCenter;

    protected IdrQuarticAuthalic(ParameterValueGroup parameters) throws ParameterNotFoundException {
		super(parameters);
	...
	public static class Provider extends AbstractProvider {
        ...
        static final ParameterDescriptorGroup PARAMETERS = createDescriptorGroup(new NamedIdentifier[] {
                new NamedIdentifier(CitationImpl.OGC,      "Quartic_Authalic"),
    			new NamedIdentifier(CitationImpl.EPSG,     "Quartic Authalic"),
    			new NamedIdentifier(CitationImpl.EPSG,     "Quartic-Authalic"),
...
//                                    VocabularyKeys.EQUIDISTANT_CYLINDRICAL_PROJECTION))
        ...
        {
            return new IdrQuarticAuthalic(parameters);
        }
    }
