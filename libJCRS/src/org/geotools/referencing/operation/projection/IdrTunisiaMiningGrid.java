...
public class IdrTunisiaMiningGrid extends MapProjection {

    private final double latitudeOfOrigin;

    protected IdrTunisiaMiningGrid(ParameterValueGroup parameters) throws ParameterNotFoundException {
		super(parameters);
	...
	public static class Provider extends AbstractProvider {
        ...
        static final ParameterDescriptorGroup PARAMETERS = createDescriptorGroup(new NamedIdentifier[] {
                new NamedIdentifier(CitationImpl.OGC,      "Tunisia Mining Grid"),
    			new NamedIdentifier(CitationImpl.EPSG,     "Tunisia Mining Grid"),
                new NamedIdentifier(CitationImpl.EPSG,     "Tunisia_Mining_Grid"),
                new NamedIdentifier(CitationImpl.EPSG,     "9816"),
...
//                                    VocabularyKeys.EQUIDISTANT_CYLINDRICAL_PROJECTION))
        ...
        {
            return new IdrTunisiaMiningGrid(parameters);
            //return null;
