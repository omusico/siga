...
public class IdrWinkelI extends MapProjection {
    protected final double standardParallel;
    protected IdrWinkelI(final ParameterValueGroup parameters) throws ParameterNotFoundException {
        super(parameters);
    ...
    public static class Provider extends AbstractProvider {
        ...
        static final ParameterDescriptorGroup PARAMETERS = createDescriptorGroup(new NamedIdentifier[] {
            new NamedIdentifier(CitationImpl.OGC,     "Winkel_I"),
            new NamedIdentifier(CitationImpl.GEOTIFF, "Winkel I"),
            new NamedIdentifier(CitationImpl.EPSG,    "Winkel I"),
        ...
        {
            return new IdrWinkelI(parameters);
        }
    }
