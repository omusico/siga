...
public class IdrWinkelTripel extends MapProjection {
    protected final double standardParallel;
    protected IdrWinkelTripel(final ParameterValueGroup parameters) throws ParameterNotFoundException {
        super(parameters);
    ...
    public static class Provider extends AbstractProvider {
        ...
        static final ParameterDescriptorGroup PARAMETERS = createDescriptorGroup(new NamedIdentifier[] {
            new NamedIdentifier(CitationImpl.OGC,     "Winkel Tripel"),
            new NamedIdentifier(CitationImpl.GEOTIFF, "Winkel-Tripel"),
            new NamedIdentifier(CitationImpl.EPSG,    "Winkel_Tripel"),
        ...
        {
            return new IdrWinkelTripel(parameters);
        }
    }
