...
//		print(ds.getRasterBuf());
	...
	private void dataTest1(IBuffer raster) throws InterruptedException {
	...
	private void dataTest2(IBuffer raster) throws InterruptedException {
	...
	public void compareRaster(IBuffer raster, int band0[], int band1[], int band2[]) throws InterruptedException {
		int cont = 0;
	 ...
	 */
	public void print(IBuffer raster) throws InterruptedException {
		System.out.println("");
