...
public class BufferFactory {
	...
	private double[] requestFillingWithNoData(Extent requestExtent, Extent fitExtent, int bufWidth, int bufHeight) 
		...
		for(int i = 0; i < buf.getBandCount(); i++) {
			...
			case IBuffer.TYPE_BYTE:buf.assign(i, buf.getByteNoDataValue());break;
			case IBuffer.TYPE_SHORT:buf.assign(i, buf.getShortNoDataValue());break;
			case IBuffer.TYPE_INT:buf.assign(i, buf.getIntNoDataValue());break;
			case IBuffer.TYPE_FLOAT:buf.assign(i, buf.getFloatNoDataValue());break;
			case IBuffer.TYPE_DOUBLE:buf.assign(i, buf.getNoDataValue());break;
			}
		}	
