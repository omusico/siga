...
public class GdalDriver extends RasterDataset {
	...
	public static final String FORMAT_ASCIIGRID= "AAIGrid";
	...
	public static void register() {
		...
		point.register("bmp", GdalDriver.class);
		point.register("gif", GdalDriver.class);
		point.register("tif", GdalDriver.class);
		point.register("tiff",GdalDriver.class);
		point.register("jpg", GdalDriver.class);
		point.register("jpeg", GdalDriver.class);
		point.register("png", GdalDriver.class);
		point.register("vrt", GdalDriver.class);
		point.register("dat", GdalDriver.class); // Envi
		point.register("lan", GdalDriver.class); // Erdas
		point.register("gis", GdalDriver.class); // Erdas
		point.register("img", GdalDriver.class); // Erdas
		point.register("pix", GdalDriver.class); // PCI Geomatics
		point.register("aux", GdalDriver.class); // PCI Geomatics
		point.register("adf", GdalDriver.class); // ESRI Grids
		point.register("mpr", GdalDriver.class); // Ilwis
		point.register("mpl", GdalDriver.class); // Ilwis
		//point.register("map", GdalDriver.class); // PC Raster
		point.register("asc", GdalDriver.class);
		point.register("pgm", GdalDriver.class); //Ficheros PNM en escala de grises
		point.register("ppm", GdalDriver.class); //Ficheros PNM en RGB
		point.register("rst", GdalDriver.class); //IDRISIS
		point.register("rmf", GdalDriver.class); //Raster Matrix Format
		point.register("nos", GdalDriver.class);
		point.register("kap", GdalDriver.class); 
	...
	public String translateFileName(String fileName) {
		if(fileName.endsWith("hdr")) {
			String asocFile =  fileName.substring(0, fileName.lastIndexOf("."));
			File test = new File(asocFile);
			if (!test.exists()) {
				// Probamos con .raw
				asocFile = asocFile + ".raw";
			}
			return asocFile;
		}
	...
	/*
	 * (non-Javadoc)
	 * @see org.gvsig.raster.dataset.RasterDataset#needEnhanced()
	 */
	public boolean needEnhanced() {
		return (!(getBandCount() >= 3 && getDataType()[0] == IBuffer.TYPE_BYTE));
	}
}
