...
public class MemoryRasterDriver extends RasterDataset {
	...
	public static void register() {
		...
		point.register(new MemoryRasterDriverParam().getFormatID(), MemoryRasterDriver.class);
	}
	 ...
	 */
	public Object getData(int x, int y, int band) throws InterruptedException {
	 ...
	 */
	public IBuffer getWindowRaster(double ulx, double uly, double lrx, double lry, BandList bandList, IBuffer rasterBuf) throws InterruptedException {
	 ...
	 */
	public IBuffer getWindowRaster(double x, double y, double w, double h, BandList bandList, IBuffer rasterBuf, boolean adjustToExtent) throws InterruptedException {
	 ...
	 */
	public IBuffer getWindowRaster(double minX, double minY, double maxX, double maxY, int bufWidth, int bufHeight, BandList bandList, IBuffer rasterBuf, boolean adjustToExtent) throws InterruptedException {
	 ...
	 * @throws InterruptedException 
	 */
	private void writeByteBuffer(IBuffer rasterBuf, double stepX, double stepY, Point2D begin, BandList bandList) throws InterruptedException {
		int xPx = 0, yPx = 0;
	 ...
	 * @throws InterruptedException 
	 */
	private void writeShortBuffer(IBuffer rasterBuf, double stepX, double stepY, Point2D begin, BandList bandList) throws InterruptedException {
		int xPx = 0, yPx = 0;
		for (int iBand = 0; iBand < buffer.getBandCount(); iBand++) {
			int[] drawableBands = bandList.getBufferBandToDraw(this.getFName(), iBand);
			if(drawableBands == null || (drawableBands.length == 1 && drawableBands[0] == -1))
	 ...
	 * @throws InterruptedException 
	 */
	private void writeIntBuffer(IBuffer rasterBuf, double stepX, double stepY, Point2D begin, BandList bandList) throws InterruptedException {
		int xPx = 0, yPx = 0;
		for (int iBand = 0; iBand < buffer.getBandCount(); iBand++) {
			int[] drawableBands = bandList.getBufferBandToDraw(this.getFName(), iBand);
			if(drawableBands == null || (drawableBands.length == 1 && drawableBands[0] == -1))
	 ...
	 * @throws InterruptedException 
	 */
	private void writeFloatBuffer(IBuffer rasterBuf, double stepX, double stepY, Point2D begin, BandList bandList) throws InterruptedException {
		int xPx = 0, yPx = 0;
		for (int iBand = 0; iBand < buffer.getBandCount(); iBand++) {
			int[] drawableBands = bandList.getBufferBandToDraw(this.getFName(), iBand);
			if(drawableBands == null || (drawableBands.length == 1 && drawableBands[0] == -1))
	 ...
	 * @throws InterruptedException 
	 */
	private void writeDoubleBuffer(IBuffer rasterBuf, double stepX, double stepY, Point2D begin, BandList bandList) throws InterruptedException {
		int xPx = 0, yPx = 0;
		for (int iBand = 0; iBand < buffer.getBandCount(); iBand++) {
			int[] drawableBands = bandList.getBufferBandToDraw(this.getFName(), iBand);
			if(drawableBands == null || (drawableBands.length == 1 && drawableBands[0] == -1))
	 ...
	 */
	public IBuffer getWindowRaster(int x, int y, int w, int h, BandList bandList, IBuffer rasterBuf) throws InterruptedException {
		setView(
	 ...
	 */
	public IBuffer getWindowRaster(int x, int y, int w, int h, int bufWidth, int bufHeight, BandList bandList, IBuffer rasterBuf) throws InterruptedException {
		setView(
				new Extent( RasterUtilities.getMapRectFromPxRect(getExtent().toRectangle2D(), 
							getWidth(), 
							getHeight(),
	 ...
	 */
	public Object readCompleteLine(int line, int band) throws InvalidSetViewException, FileNotOpenException, RasterDriverException, InterruptedException {
		switch(buffer.getDataType()){
