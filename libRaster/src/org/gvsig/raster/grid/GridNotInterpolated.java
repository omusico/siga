...
public class GridNotInterpolated extends GridReader {
	 ...
	 */
	public byte getCellValueAsByte(int x, int y) throws RasterBufferInvalidAccessException, RasterBufferInvalidException, InterruptedException {
		try{
	 ...
	 */
	public double getCellValue(int x, int y)throws RasterBufferInvalidAccessException, InterruptedException {
		try{
