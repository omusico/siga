...
/**
 * Gestor del filtro de conversión de RGB a CMYK.
 *
 * @version 30/11/2007
 * @author Nacho Brodin (nachobrodin@gmail.com)
 */
public class RGBToCMYKManager  implements IRasterFilterListManager {

	protected RasterFilterList	filterList = null;

	/**
	 * Registra RGBToCMYKManager en los puntos de extension de RasterFilter
	 */
	public static void register() {
		ExtensionPoint point = ExtensionPoint.getExtensionPoint("RasterFilter");
		point.register("RGBToCMYK", RGBToCMYKManager.class);
	}
	 ...
	 */
	public RGBToCMYKManager(RasterFilterListManager filterListManager) {
	...
	public void addRGBToCMYKFilter(int outputType, int[] renderBands) throws FilterTypeException {
		RasterFilter filter = new RGBToCMYKByteFilter();
	...
	int[] renderBands = { 0, 1, 2 };
		if (classFilter.equals(RGBToCMYKFilter.class)) {
			...
			addRGBToCMYKFilter(out, renderBands);
		}
	}
