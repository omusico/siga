...
/**
 * Proceso que aplica el filtro de Moda a un raster de tipo short
 * 
 * 23/07/2008
 * @author Nacho Brodin nachobrodin@gmail.com
 */
public class ModeShortFilter extends ModeFilter {
	private short[]          window = null;
	private short            tempValue       = 0;

	public ModeShortFilter() {
		super();
	}
	...
	public void process(int col, int line) throws InterruptedException {
		for (int band = 0; band < raster.getBandCount(); band++) {
			...
			rasterResult.setElem(line, col, band, (short) tempValue);
		}
	}
