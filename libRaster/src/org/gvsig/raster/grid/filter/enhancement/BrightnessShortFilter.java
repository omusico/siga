...
/**
 * Filtro de brillo para buffer de datos tipo short. En el método de proceso
...
public class BrightnessShortFilter extends BrightnessFilter {
	...
	public void process(int col, int line) throws InterruptedException {
		for (int i = 0; i < raster.getBandCount(); i++)
			rasterResult.setElem(line, col, i, (byte) calcBrightness((int) raster.getElemShort(line, col, i) & 0xff));
	}
