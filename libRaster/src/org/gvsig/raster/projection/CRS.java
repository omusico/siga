...
public class CRS {
	...
	public static IProjection convertWktToIProjection(String wkt) {
		...
		try {
			...
			Logger.getLogger(CRS.getSingleton().getClass().getName()).debug("Problemas obteniendo el código EPSG", e);
	...
	public static String convertIProjectionToWkt(IProjection projection) {
		...
		try {
			...
			Logger.getLogger(CRS.getSingleton().getClass().getName()).debug("Problemas obteniendo el código WKT", e);
