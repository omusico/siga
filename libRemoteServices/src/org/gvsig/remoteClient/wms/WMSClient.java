...
//    private WMSLayer rootLayer;
    ...
    /**
     * Gets response formats the server will return when GetFeatureInfo
     * The WMS specification does not specify an output format for a response.
     * ESRI uses these:
     ...
     *  (the filename has to have an .html extension). The MIME type returned by the Class templates
    ...
    public Vector getInfoFormats() {        
        return handler.getServiceInformation().infoFormats;         
    } 
